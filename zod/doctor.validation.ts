import { Gender, ICreateDoctorPayload, IUpdateDoctorPayload } from '@/types/doctor.types'
import z from 'zod'
...
export const createDoctorFormZodSchema = z.object({
    ...
    currentWorkingPlace: z
             .string()
             .trim()
             .min(1, 'Current working place must be at least 2 characters')
    ...
    doctor: z
          .object({
            ...
            contactNumber: z
                            ...
                            .trim()
                            .min(11, 'Contact number must be at least 11 characters')
                            .max(14, 'Contact number must be at least 14 characters')
                            .optional(),
            address:z.preprocess(
                emptyStringToUndefined,
                z
        ...
        qualification: z
                .string()
                .trim()
                .min(2, 'Qualification must be at least 2 character')
                .max(50, 'Qualification must be at most 50 characters')
                .optional(),
        currentWorkingPlace: z
              .string()
