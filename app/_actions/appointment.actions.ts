...
import { bookAppointment, bookAppointmentWithPayLater, initiateAppointmentPayment } from "@/services/appointment.service"
import { ApiErrorResponse, ApiResponse } from "@/types/api.types"
import { IBookAppointmentPayload, IBookAppointmentResult, IInitiatePaymentResult } from "@/types/appointment.types"
...
export const initiateAppointmentPaymentAction = async (
  ...
  try {
    return await initiateAppointmentPayment(appointmentId) as ApiResponse<IInitiatePaymentResult>
  } catch (error: unknown) {
    return {
      success: false,
